...
export const LoginRegisterContainer = (props) => {
  const [toggleLoginOrRegister, setToggleLoginOrRegister] = React.useState(
    false
  );
    ...
    <Grid container justify="center">
      <Box paddingTop={5}>
        <Box paddingBottom={1}>
          ...
          >
            <Button
              onClick={() => setToggleLoginOrRegister(!toggleLoginOrRegister)}
              color="secondary"
              variant={toggleLoginOrRegister ? "contained" : "outlined"}
            >
              Login
            </Button>
            <Button
