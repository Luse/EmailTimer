...
import { TextField, Box, Typography, Button, makeStyles } from '@material-ui/core';
    ...
    return <Grid item container xs={12} justify="center" alignItems="center">
        ...
        <Grid item xs={12} md={12}>
            ...
            {mailList.submited === false && <Box>
                ...
                <TextField onChange={(event) => setEmail(event.target.value)} type="email" color="secondary" fullWidth label="Email adress" />
                <Typography variant="body1" color="primary">
                    We promise to only send you relevant information
                </Typography>
                <Box paddingTop={2}>
                    <form onSubmit={handleSubmit}>
                        <Button type="submit" disabled={!validationPattern.test(Email)} fullWidth variant="contained" color="primary">
                            Subscribe
                </Button>
                    </form>
                </Box>
