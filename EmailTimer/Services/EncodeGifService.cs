...
namespace EmailTimer.Services
{
    public class EncodeGifService
    {
        public static async Task<byte[]> Create(DateTime targetTime)
        {
            ...
            var height = 26;
            var fontSize = 24;
            var backgroundHex = "F8F5EF";
            var fontColorHex = "484C57";
            ...
            if (DateTime.Now > targetTime)
            {
                ...
                image.Mutate(x => x
                    ...
                    .DrawText(textGraphicsOptions, messageDone, fontFamily.CreateFont(fontSize), Color.FromHex(fontColorHex), new SixLabors.Primitives.PointF(1, 1)));
            ...
            for (int i = 1; i < 61; i++)
            {
                ...
                image.Mutate(x => x
                    .BackgroundColor(Color.FromHex(backgroundHex))
                    .DrawText(textGraphicsOptions, subs, fontFamily.CreateFont(fontSize), Color.FromHex(fontColorHex), new SixLabors.Primitives.PointF(1, 1)));
